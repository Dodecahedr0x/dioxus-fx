...
//! [`FxStyle`] once near the root of your app.
...
.dfx{--dfx-size:40px;--dfx-color:currentColor;--dfx-duration:1s;--dfx-track:color-mix(in srgb,currentColor 15%,transparent);box-sizing:border-box}
.dfx *{box-sizing:border-box}
@supports not (color: color-mix(in srgb,red 50%,transparent)){.dfx{--dfx-track:rgba(128,128,128,.25)}}
@media (prefers-reduced-motion:reduce){
.dfx-decorative,.dfx-decorative *{animation:none!important;transition-duration:.01ms!important}
.dfx-loader,.dfx-loader *{animation-duration:calc(var(--dfx-duration)*3)!important}
}
"#;
...
#[allow(unused_macros)]
macro_rules! dfx_style {
    ($key:literal, $css:expr) => {
        rsx! {
            ::dioxus::prelude::document::Style { href: "dfx:base", {crate::style::BASE_CSS} }
            ::dioxus::prelude::document::Style { href: concat!("dfx:", $key), {$css} }
        }
    };
}

#[allow(unused_imports)]
pub(crate) use dfx_style;
...
fn fragments() -> Vec<&'static str> {
    ...
    #[cfg(feature = "surface")]
    parts.extend_from_slice(crate::surface::CSS);
    #[cfg(feature = "buttons")]
...
pub fn FxStyle() -> Element {
    ...
    rsx! {
        document::Style { href: "dfx:all", {css} }
    }
}
