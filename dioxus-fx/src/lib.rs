...
pub use style::{FxStyle, stylesheet};
...
/// ```
pub mod prelude {
    pub use crate::{FxStyle, stylesheet};
    ...
    // The `DFX_`-prefixed class names, plus `PrimitivesStyle`. Exported as a
    // module too, so `primitives::DFX_ZOOM` reads as well as the bare name.
    #[cfg(feature = "primitives")]
