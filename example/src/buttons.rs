...
pub fn animated_button_slide_arrow(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_sparkle(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_morph(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_ring(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_glare(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_text_reveal(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_magnetic(#[default = "Action"] label: String) -> Element {
...
pub fn animated_button_expand_ring(#[default = "Action"] label: String) -> Element {
...
pub fn focus_blur_links(#[default = "2px"] blur: String) -> Element {
    rsx! {
        FocusBlurLinks {
            blur,
            items: vec![
